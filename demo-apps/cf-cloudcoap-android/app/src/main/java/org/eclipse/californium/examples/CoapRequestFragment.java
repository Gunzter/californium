...
public class CoapRequestFragment extends Fragment implements CoapTaskHandler {
    ...
    protected void resultDisplay(CoapTaskResult result) {
        ...
        List<String> rids = ReceivetestClient.parse(errors);
        ...
        if (result.response != null) {
            ...
            if (result.links != null) {
                ...
                Statistic.updateLostResponses(getApplicationContext(), lostResponseTimes);
                if (size != rids.size()) {
                    errors = ReceivetestClient.serialize(rids);
